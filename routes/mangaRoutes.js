...
const {mangaById , getAll , addManga,deleteManga,updateManga,search, random} = require('../controllers/mangaController')
...
router.get("/:id",mangaById)
router.get("/search/:name",search)
router.delete("/:id",deleteManga)
router.put("/:id",updateManga)
router.post("/",[upload.single('cover')],addManga)
